...
###########################################################################
# === TWFE Regressions, With controls (clustered at the county level) === #
###########################################################################
twfe_models <- lapply(dep_vars, \(y) feols(
  as.formula(paste0(y, " ~ Connected_railway +
                    Dist_hamb_year + 
...
#############################################################################################
# === Callaway and Sant’Anna Regressions, With controls (clustered at the county level) === #
#############################################################################################
...
# create and store latex table
sink("Tables/railways_and_grundtvig_controls_clustered_county.tex")
